...
define('_SESSION_PATH_',  _ADMIN_PATH_ . "ses_e40165901e2ed73349029792{$path_separator}");
...
//------------------------------------------------------------------------
// Define constants for the current version of King Bot, and for the OS name and version
//------------------------------------------------------------------------

define('VERSION', trim(file_get_contents(_BASE_PATH_ . 'version.txt'))); # King Bot version
$os = php_uname('s');
$osv = php_uname('v');
...
// Time zone settings
//------------------------------------------------------------------------
$time_zone_locale = 'America/Argentina/Buenos_Aires'; // a full list can be found at http://uk.php.net/manual/en/timezones.php
...
$error_response = 'Oi, meu nome é Tatiane, sou vendedora da NET. Tudo bem?';
$unknown_user = 'Seeker';
...
//------------------------------------------------------------------------
// Set King Bot Website URLs
//------------------------------------------------------------------------
    define('DOCS_URL', 'https://github.com/King-Bot/King-Bot/wiki');
    define('FORUM_URL', 'http://forum.devn1.com/');
    define('BUGS_EMAIL', 'bugs@devn1.com');
