 ...
 * DATE: 12-12-2014
 * DETAILS: Allows admins to file bug reports directly to the King Bot dev team
 ***************************************/
...
$headerTitle    = 'Actions:';
$pageTitle      = 'My-King Bot - Report a Bug';
$mainContent    = $func();
...
function sendMail()
{
    ...
    $senderInfo = "\n\nThis message was sent through the King Bot Bug Reporting System at $localServer, from $remoteAddr at $time on $date\n";
    $message .= $senderInfo;
    ...
    if ($email != "" && $name != "" && $subject != "" && $cba == 0 && $cbip == 0 && $message != "" && ($captcha == $capKey))
    {
      ...
      With your help, we can make King Bot even better than ever!<br />
      </p>
