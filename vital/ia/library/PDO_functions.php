 ...
 *
 * @link     http://blog.devn1.com/?p=1340
...
function db_open()
{
    ...
    try
    {
        ...
        //exit('King Bot has encountered a problem with connecting to the database. With any luck, the following information will help: ' . $e->getMessage());
        $errMsg = <<<endMsg
King Bot has encountered a problem with connecting to the database. With any luck, the following information will help:<br>
 ...
 *
 * @link     http://blog.devn1.com/?p=1343
