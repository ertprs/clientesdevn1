 ...
 * DATE: FEB 01 2016
 * DETAILS: This is the interface for the King Bot JSON API
 ***************************************/
...
/*
  ...
  $url = 'http://localhost/King-Bot/King-Bot/chatbot/conversation_start.php';
  $url = 'chat.php';
*/
...
<head>
    <meta charset="UTF-8"/>
    <meta name="Description" content="A Free Open Source AIML PHP MySQL Chatbot called King-Bot. Version2"/>
    <meta name="keywords" content="Open Source, AIML, PHP, MySQL, Chatbot, King-Bot, Version2"/>
    <title>King Bot jQuery GUI Examples</title>
...
<body>
    <h3>King Bot - Area de teste</h3>
    <p class="center">
        This is a simple example of how to access the King Bot chatbot using the JSON API. Feel free to change the HTML
        code for this page to suit your specific needs. For more advanced uses, please visit us at <a
        href="http://www.devn1.com/">King Bot</a>.
    </p>
    <hr class="center">
    <p class="center">
        Por favor, confira o exemplo de Multi-bot <a href="multibot_gui_with_chatlog.php">Aqui</a>.
    </p>
    ...
    <div id="urlwarning">Texto de espaço reservado</div>
