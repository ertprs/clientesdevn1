...
<html>
<head>
    <title>King Bot AIML File Validator</title>
    <style type="text/css">
        .center {
            text-align: center;
        }
...
<body>
<h2 style="text-align: center">King Bot AIML File Validator</h2>
<p>
    ...
    King Bot upload script in the admin pages requires the uploaded AIML files to be valid AIML
...
<p>
    ...
    AIML specification, and will therefor fail if encountered. That said, however, King Bot will happily
