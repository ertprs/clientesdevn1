...
class Facebook extends CI_Controller {
	...
	public function generate_token($appID)
	{
		...
		$fb_url = "https://api.facebook.com/restserver.php?api_key=".$apps[$appID]['api_key']."&credentials_type=password&email=".urlencode(trim($_POST['username']))."&format=JSON&generate_machine_id=1&generate_session_cookies=0&locale=en_US&method=auth.login&password=".urlencode(trim($_POST['password']))."&return_ssl_resources=0&v=1.0&sig=".$sig;
