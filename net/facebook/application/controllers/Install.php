...
class Install extends CI_Controller {
	...
	public function step2()
	{
		...
		if($this->form_validation->run() === true) {
			...
			$json = $this->curl->get("http://gounane.com/manager/verify/?purchaseCode=".$this->input->post('purchaseCode', TRUE)."&v=".APP_VERSION_DEV."&driver=".BD_DRIVER."&domain=".base_url()."&productID=13302046");
