...
function load_chatbox(settings) {
    ...
    var iframeOptions = {
        ...
        resizedCallback: function (messageData) {
            messageData.width = 354;
            //console.log('H= ' + messageData.height + ' W= ' + messageData.width);  
            // Callback fn when resize is received
            if (messageData.height < 150 && messageData.height > 60) {            
                if (settings && settings.visitor_widget_type == 'chaticon') {
                    ...
                    if (settings.visitor_widget_type == 'chaticon') {
                        if (settings.chat_icon_size == 'medium-size') {
                            ...
                            messageData.width = 49 + offsetWidth;
                        }
                    }
                }
            }

            if(messageData.height < 190 && messageData.height > 150) {
    ...
    if (typeof require !== 'undefined') {
        var iFrameResizerPath = cburl + 'assets/cmodule-chat/js/iframeResizer.min.js';
...
function initChatbox(theUrl, callback)
{
...
initChatbox(cburl + 'index.php?d=visitors&c=chatbox&m=settings_json&token='+access_token, load_chatbox);