        ...
        <tr>
            <td>
                <table width="100%" bgcolor="#f1f1f1" cellpadding="0" cellspacing="0" border="0" style="font-size: 14px; color:#6e6e6e; padding: 35px 45px; margin-bottom: 15px; border-radius: 4px; ">
                    <tbody>
                        <tr>
                            <td><p style=" color:#383838; font-size: 24px; margin-top: 0; margin-bottom: 10px;"><?php echo $this->lang->line('hello') . ' ' . $receiver->name; ?>,</p></td>
                        </tr>
                        <tr>
                            <td><p style="margin-top: 0; margin-bottom: 20px;"><?php echo $this->lang->line('operators_chat_transcript'); ?></p></td>
                        </tr>
                        <tr>
                            <td>
